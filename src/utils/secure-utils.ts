 ...
 *
 * Usa threshold absoluto: se a diferença entre outerWidth/outerHeight
 * e innerWidth/innerHeight exceder 160px, DevTools está aberto.
 *
 * 160px é calibrado para não disparar com:
 * - Barra de favoritos (~30px)
 * - Extensões do browser (~20-30px)
 * - Tab bar + address bar (~80-90px)
 * Total browser chrome máximo realista: ~150px
 *
 * DevTools docked mínimo usável: ~200px+
 */
